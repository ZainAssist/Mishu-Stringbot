...
from Zainu.plugins.generate import generate_session, ask_ques, buttons_ques
from Zainu import LOGGER
...
ERROR_MESSAGE = (
    ...
    "\n\nPlease visit @About_Zain if this message doesn't contain any "
